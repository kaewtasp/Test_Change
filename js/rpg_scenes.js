...
Scene_Map.prototype.createTest = function() {
    this._Test = new Test_Window(300, 300);
    //this._Test.y = Graphics.boxHeight - this._Test.height;
    this.addChild(this._Test);
    //this.addWindow(this._Test);
    //this.open();
};
Scene_Map.prototype.createGold2 = function() {
    this._gold2 = new Window_Gold2(0, 0);
    this._gold2.y = Graphics.boxHeight - this._gold2.height;
    this.addChild(this._gold2);
    //this.addWindow(this._Test);
    //this.open();
};
...
//------------------------------------------------------------
Scene_Menu.prototype.createTest = function() {
    this._Test = new Test_Window(0, 0);
    this._Test.y = Graphics.boxHeight - this._Test.height;
    this.addWindow(this._Test);
};
//-----------------------------------------------------------
